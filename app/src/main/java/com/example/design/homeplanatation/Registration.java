package com.example.design.homeplanatation;
...
public class Registration extends AppCompatActivity implements View.OnClickListener {
                ...
                else
                {
                    ...
                    databaseReference.child("Admin_User").child(firebaseAuth.getCurrentUser().getUid())
                        ...
                        public void onSuccess(Void aVoid) {
                            Intent loginactvity=new Intent(Registration.this,Login.class);
    ...
    private void uploadImage() {
        final  StorageReference reference=storageReference.child("UserImage/"+ UUID.randomUUID().toString());
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(Registration.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Registration.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
